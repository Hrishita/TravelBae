...
export const Write = () => {
  ...
  return (
    ...
    <Box component={'div'} className="container" style={{ marginTop: "5rem" }}>
      ...
      <ModalComp
        ...
        text={alert.message}
      />
      <Box component={'div'} className="image-upload my-3 d-flex flex-column justify-content-center align-items-center">
        {!image ? (
          <Box
          component={'div'}
            style={{ width: "100%" }}
          ...
          >
            <Box component={'div'} className="input-group d-flex justify-content-center align-items-center flex-column">
          ...
          <Box component={'div'} className="d-flex flex-column align-items-center justify-content-center">
