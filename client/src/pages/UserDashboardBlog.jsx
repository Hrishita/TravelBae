       ...
       <Grid item xs={12}>
         ...
         <Paper sx={{ display: "flex" }}>
           <Box sx={{ display: "flex" }} onClick={() => goToBlog(blog.blog_id)}>
             <img src={blog.image ? blog.image : "https://images.pexels.com/photos/6965273/pexels-photo-6965273.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"} width="200rem" alt="Blog Image" /> 
           </Box>
