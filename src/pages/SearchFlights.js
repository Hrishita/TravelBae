...
import { Alert, Avatar, Button, FormControl, InputLabel, MenuItem, Select, Slider, Snackbar, TextField, Typography } from '@mui/material'
    ...
    <div className='container'>
        ...
        <FormControl fullWidth className='my-2'>
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-end', mx: 1, my: 1 }}>
                ...
                <TextField id="input-with-sx" label="Where From?" variant="standard" />
            </Box>
            <Box sx={{ display: 'flex', alignItems: 'flex-end', mx: 1, my: 1 }}>
                <LocationCity sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
                <TextField id="input-with-sx" label="Where To?" variant="standard" />
            </Box>
            <Box sx={{mx: 1, my: 1}}>
            ...
            <div style={{flex: 1, flexBasis: '100%'}}>
                ...
                <Slider  defaultValue={200} aria-label="Default" valueLabelDisplay="auto" min={100} max={200} />
            </div>
            <Button className='mx-2 my-2' variant='contained'>Search</Button>
        </div>
        <div className='card shadow my-3'>
            <Typography className='mx-4 my-3' variant='h4' fontWeight={'600'}>All flights</Typography>
            {
                fakeData.map((d, index) => {
                    return (
                    <ButtonBase onClick={onShowSnackbar} className='mx-2 my-2 d-flex flex-row justify-content-between align-items-center flex-wrap' style={{cursor: 'pointer'}}>
                    {/* <div onClick={onShowSnackbar} className='mx-2 my-2 d-flex flex-row justify-content-between align-items-center flex-wrap' style={{cursor: 'pointer'}}> */}
                        <div className='d-flex flex-row justify-content-between align-items-center py-2'>
                            ...
                            <div className='d-flex flex-column justify-content-center align-items-start'>
                                <Typography variant={'body1'}> {d.startTime} - {d.endTime} </Typography>
